...
// Actor Stats
constexpr s32 hp = 12;
constexpr s32 dmgNormalSpinyFlip = 3;
constexpr s32 dmgSuperSpinyFlip = 4;
constexpr s32 dmgUltraSpinyFlip = 5;
...
EvtScript EVS_TakeTurn = {
    ...
    Switch(LVar9)
        CaseEq(PARTNER_RANK_NORMAL)
            Wait(2)
            Call(EnemyDamageTarget, ACTOR_SELF, LVar0, DAMAGE_TYPE_NO_CONTACT, 0, 0, dmgNormalSpinyFlip, BS_FLAGS1_TRIGGER_EVENTS)
        CaseEq(PARTNER_RANK_SUPER)
            Wait(2)
            Call(EnemyDamageTarget, ACTOR_SELF, LVar0, DAMAGE_TYPE_NO_CONTACT, 0, 0, dmgSuperSpinyFlip, BS_FLAGS1_TRIGGER_EVENTS)
        CaseEq(PARTNER_RANK_ULTRA)
            Wait(2)
            Call(EnemyDamageTarget, ACTOR_SELF, LVar0, DAMAGE_TYPE_NO_CONTACT, 0, 0, dmgUltraSpinyFlip, BS_FLAGS1_TRIGGER_EVENTS)
    EndSwitch
    Switch(LVar0)
