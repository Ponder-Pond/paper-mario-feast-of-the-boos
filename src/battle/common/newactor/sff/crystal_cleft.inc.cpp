...
// Actor Stats
constexpr s32 hp = 4;
constexpr s32 dmgTackle = 3;
constexpr s32 dmgCharged = 8;
...
EvtScript EVS_Move_Charge = {
    ...
    Wait(2)
    Call(SetGoalToTarget, ACTOR_SELF)
    Call(EnemyDamageTarget, ACTOR_SELF, LVar0, 0, 0, 0, dmgCharged, BS_FLAGS1_TRIGGER_EVENTS)
    Switch(LVar0)
...
ActorBlueprint CrystalCleft = {
    .flags = 0,
    .maxHP = crystal_cleft::hp,
    .type = ACTOR_TYPE_CRYSTAL_CLEFT,
    .level = ACTOR_LEVEL_CRYSTAL_CLEFT,
    .partCount = ARRAY_COUNT(crystal_cleft::ActorParts),
    .partsData = crystal_cleft::ActorParts,
    .initScript = &crystal_cleft::EVS_Init,
    .statusTable = crystal_cleft::StatusTable,
    .escapeChance = 70,
    .airLiftChance = 30,
    .hurricaneChance = 30,
    .spookChance = 30,
