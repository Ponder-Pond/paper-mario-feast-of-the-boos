...
EvtScript EVS_Attack_FrostBreath = {
    ...
    EndIf
    Call(FrostBreath, LVar2, LVar0, LVar1, LVar2, LVar3, 30, 120, 0, 120)
    Wait(1)
...
ActorBlueprint FrostPiranha = {
    .flags = 0,
    .maxHP = frost_piranha::hp,
    .type = ACTOR_TYPE_FROST_PIRANHA,
    .level = ACTOR_LEVEL_FROST_PIRANHA,
    .partCount = ARRAY_COUNT(frost_piranha::ActorParts),
    .partsData = frost_piranha::ActorParts,
    .initScript = &frost_piranha::EVS_Init,
    .statusTable = frost_piranha::StatusTable,
    .escapeChance = 70,
    .airLiftChance = 20,
    .hurricaneChance = 20,
    .spookChance = 20,
