...
extern EvtScript EVS_Ember_FlyHome;
extern EvtScript EVS_Attack_Tackle;
extern EvtScript EVS_Attack_ShootPlayer;
extern EvtScript EVS_Attack_ShootPartner;
...
constexpr s32 dmgShootPlayer = 4;
constexpr s32 dmgShootPartner = 2;
...
EvtScript EVS_Attack_Tackle = {
    ...
    Call(JumpToGoal, ACTOR_SELF, 10, false, true, false)
    Wait(2)
    Call(EnemyDamageTarget, ACTOR_SELF, LVar0, DAMAGE_TYPE_FIRE, 0, 0, dmgTackle, BS_FLAGS1_TRIGGER_EVENTS)
    Switch(LVar0)
...
EvtScript EVS_Attack_ShootPlayer = {
    ...
    Call(FlyToGoal, ACTOR_SELF, 0, -10, EASING_QUADRATIC_OUT)
    Wait(2)
    Call(EnemyDamageTarget, ACTOR_SELF, LVar0, DAMAGE_TYPE_FIRE, 0, 0, dmgShootPlayer, BS_FLAGS1_TRIGGER_EVENTS)
    Switch(LVar0)
        CaseOrEq(HIT_RESULT_HIT)
        CaseOrEq(HIT_RESULT_NO_DAMAGE)
            Call(UseBattleCamPreset, BTL_CAM_DEFAULT)
...
EvtScript EVS_Attack_ShootPartner = {
    ...
    ExecWait(EVS_ShootFire)
    Wait(2)
    Call(EnemyDamageTarget, ACTOR_SELF, LVar0, DAMAGE_TYPE_FIRE | DAMAGE_TYPE_NO_CONTACT, 0, 0, dmgShootPartner, BS_FLAGS1_TRIGGER_EVENTS)
    Wait(20)
    Switch(LVar0)
        CaseOrEq(HIT_RESULT_HIT)
        CaseOrEq(HIT_RESULT_NO_DAMAGE)
...
ActorBlueprint SpiritBubble = {
    .flags = ACTOR_FLAG_FLYING,
    .maxHP = spirit_bubble::hp,
    .type = ACTOR_TYPE_SPIRIT_BUBBLE,
    .level = ACTOR_LEVEL_SPIRIT_BUBBLE,
    .partCount = ARRAY_COUNT(spirit_bubble::ActorParts),
    .partsData = spirit_bubble::ActorParts,
    .initScript = &spirit_bubble::EVS_Init,
    .statusTable = spirit_bubble::StatusTable,
    .escapeChance = 50,
    .airLiftChance = 90,
    .hurricaneChance = 85,
    .spookChance = 50,
