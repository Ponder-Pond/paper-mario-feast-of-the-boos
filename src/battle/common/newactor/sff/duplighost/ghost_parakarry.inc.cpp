...
// Actor Stats
constexpr s32 hp = 12;
constexpr s32 dmgNormalSkyDive = 2;
constexpr s32 dmgSuperSkyDive = 3;
constexpr s32 dmgUltraSkyDive = 5;
...
#else
            Call(EnemyDamageTarget, ACTOR_SELF, LVar0, 0, 0, 0, dmgNormalSkyDive, BS_FLAGS1_TRIGGER_EVENTS)
#endif
        CaseEq(PARTNER_RANK_SUPER)
            Wait(2)
            Call(EnemyDamageTarget, ACTOR_SELF, LVar0, 0, 0, 0, dmgSuperSkyDive, BS_FLAGS1_TRIGGER_EVENTS)
        CaseEq(PARTNER_RANK_ULTRA)
            Wait(2)
            Call(EnemyDamageTarget, ACTOR_SELF, LVar0, 0, 0, 0, dmgUltraSkyDive, BS_FLAGS1_TRIGGER_EVENTS)
    EndSwitch
