...
// Actor Stats
constexpr s32 hp = 12;
constexpr s32 dmgNormalBellyFlop = 3;
constexpr s32 dmgSuperBellyFlop = 4;
constexpr s32 dmgUltraBellyFlop = 5;
...
EvtScript EVS_TakeTurn = {
    ...
    Switch(LVarA)
        CaseEq(PARTNER_RANK_NORMAL)
            Wait(2)
            Call(EnemyDamageTarget, ACTOR_SELF, LVar0, 0, 0, 0, dmgNormalBellyFlop, BS_FLAGS1_TRIGGER_EVENTS)
        CaseEq(PARTNER_RANK_SUPER)
            Wait(2)
            Call(EnemyDamageTarget, ACTOR_SELF, LVar0, 0, 0, 0, dmgSuperBellyFlop, BS_FLAGS1_TRIGGER_EVENTS)
        CaseEq(PARTNER_RANK_ULTRA)
            Wait(2)
            Call(EnemyDamageTarget, ACTOR_SELF, LVar0, 0, 0, 0, dmgUltraBellyFlop, BS_FLAGS1_TRIGGER_EVENTS)
    EndSwitch
    Switch(LVar0)
