...
extern EvtScript EVS_Attack_Leech;
extern EvtScript EVS_Move_Clone;
extern EvtScript EVS_GetAvailableSpawnPos;
extern EvtScript EVS_CountSummoners;
...
EvtScript EVS_Attack_Leech = {
    ...
    Call(EnemyDamageTarget, ACTOR_SELF, LVarA, DAMAGE_TYPE_IGNORE_DEFENSE, 0, 0, dmgLeech, BS_FLAGS1_TRIGGER_EVENTS)
    Call(SetActorDispOffset, ACTOR_SELF, 0, 0, 0)
    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_Fuzzy_Freezy_Idle)
    Call(UseBattleCamPreset, BTL_CAM_DEFAULT)
...
Formation CloneFormation = {
    ACTOR_BY_POS(FreezyFuzzy, SummonPos, 0),
};

}; // namespace freezy_fuzzy

ActorBlueprint FreezyFuzzy = {
    .flags = 0,
    .maxHP = freezy_fuzzy::hp,
    .type = ACTOR_TYPE_FREEZY_FUZZY,
    .level = ACTOR_LEVEL_FREEZY_FUZZY,
    .partCount = ARRAY_COUNT(freezy_fuzzy::ActorParts),
    .partsData = freezy_fuzzy::ActorParts,
    .initScript = &freezy_fuzzy::EVS_Init,
    .statusTable = freezy_fuzzy::StatusTable,
    .escapeChance = 40,
    .airLiftChance = 90,
    .hurricaneChance = 90,
    .spookChance = 85,
