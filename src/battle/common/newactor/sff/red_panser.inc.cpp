...
namespace red_panser {

extern EvtScript EVS_Init;
extern s32 DefaultAnims[];
extern s32 FireballAnims[];
...
EvtScript EVS_Attack_Fireball = {
    ...
    Wait(2)
    Call(SetGoalToTarget, ACTOR_SELF)
    Call(EnemyDamageTarget, ACTOR_SELF, LVar0, DAMAGE_TYPE_NO_CONTACT | DAMAGE_TYPE_FIRE, 0, 0, dmgFireball, BS_FLAGS1_TRIGGER_EVENTS)
    Switch(LVar0)
...
ActorBlueprint RedPanser = {
    .flags = 0,
    .maxHP = red_panser::hp,
    .type = ACTOR_TYPE_RED_PANSER,
    .level = ACTOR_LEVEL_RED_PANSER,
    .partCount = ARRAY_COUNT(red_panser::ActorParts),
    .partsData = red_panser::ActorParts,
    .initScript = &red_panser::EVS_Init,
    .statusTable = red_panser::StatusTable,
    .escapeChance = 95,
    .airLiftChance = 0,
    .hurricaneChance = 0,
    .spookChance = 100,
