...
EvtScript EVS_ExitFall_mim_13_0 = {
    Loop(0)
        Wait(1)
        Call(GetPlayerPos, LVar0, LVar1, LVar2)
        IfLt(LVar1, -35)
...
EvtScript EVS_GotoMap_mim_13_0 = {
    Call(GotoMap, Ref("mim_13"), mim_13_ENTRY_0)
    Wait(100)
    Return
    End
...
MapSettings mim_11_settings = {
    .main = &mim_11::EVS_Main,
    .entryList = &mim_11::Entrances,
    .entryCount = ENTRY_COUNT(mim_11::Entrances),
