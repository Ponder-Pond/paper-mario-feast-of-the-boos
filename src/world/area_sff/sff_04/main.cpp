...
EvtScript EVS_ExitWalk_n = EVT_EXIT_WALK(60, sff_04_ENTRY_0, "sff_02", sff_02_ENTRY_1);
EvtScript EVS_ExitWalk_w = EVT_EXIT_WALK(60, sff_04_ENTRY_1, "sff_03", sff_02_ENTRY_2);
EvtScript EVS_ExitWalk_s = EVT_EXIT_WALK(60, sff_04_ENTRY_2, "sff_01", sff_01_ENTRY_0);
EvtScript EVS_ExitWalk_e = EVT_EXIT_WALK(60, sff_04_ENTRY_3, "sff_02", sff_02_ENTRY_0);
...
EvtScript EVS_EnterMap = {
    ...
    Switch(LVar0)
        CaseEq(sff_04_ENTRY_0)
            ...
            EndIf
        CaseEq(sff_04_ENTRY_1)
            Set(LVar0, Ref(EVS_BindExitTriggers))
            Exec(EnterWalk)
        CaseEq(sff_04_ENTRY_2)
            Set(LVar0, Ref(EVS_BindExitTriggers))
            Exec(EnterWalk)
...
MapSettings sff_04_settings = {
    .main = &sff_04::EVS_Main,
    .entryList = &sff_04::Entrances,
    .entryCount = ENTRY_COUNT(sff_04::Entrances),
