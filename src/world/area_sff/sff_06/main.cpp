...
EvtScript EVS_ExitWalk_sff_05_1 = EVT_EXIT_WALK(60, sff_06_ENTRY_0, "sff_05", sff_05_ENTRY_1);
EvtScript EVS_ExitWalk_arn_07_2 = EVT_EXIT_WALK(60, sff_06_ENTRY_1, "arn_07", arn_07_ENTRY_2);

EvtScript EVS_BindExitTriggers = {
    BindTrigger(Ref(EVS_ExitWalk_sff_05_1), TRIGGER_FLOOR_ABOVE, COLLIDER_deiliw, 1, 0)
...
MapSettings sff_06_settings = {
    .main = &sff_06::EVS_Main,
    .entryList = &sff_06::Entrances,
    .entryCount = ENTRY_COUNT(sff_06::Entrances),
