...
EvtScript EVS_ExitWalk_mac_02_1 = EVT_EXIT_WALK(60, sff_00_ENTRY_0, "mac_02", mac_02_ENTRY_1);

EvtScript EVS_ExitWalk_mim_01_1 = {
    SetGroup(EVT_GROUP_EXIT_MAP)
    Call(UseExitHeading, 60, sff_00_ENTRY_1)
    Exec(ExitWalk)
...
MapSettings sff_00_settings = {
    .main = &sff_00::EVS_Main,
    .entryList = &sff_00::Entrances,
    .entryCount = ENTRY_COUNT(sff_00::Entrances),
