...
EvtScript EVS_ExitWalk_n = EVT_EXIT_WALK(60, mim_02_ENTRY_0, "mim_04", sff_04_ENTRY_3);
EvtScript EVS_ExitWalk_w = EVT_EXIT_WALK(60, mim_02_ENTRY_1, "mim_04", mim_04_ENTRY_0);
EvtScript EVS_ExitWalk_s = EVT_EXIT_WALK(60, mim_02_ENTRY_2, "mim_04", mim_04_ENTRY_2);
EvtScript EVS_ExitWalk_e = EVT_EXIT_WALK(60, mim_02_ENTRY_3, "mim_01", mim_01_ENTRY_1);

EvtScript EVS_GotoMap_sff_01_5 = {
    Call(GotoMap, Ref("sff_01"), sff_01_ENTRY_5)
    Wait(100)
    Return
    End
};

EvtScript EVS_ExitPipe_sff_01_5 = EVT_EXIT_PIPE_VERTICAL(sff_02_ENTRY_4, COLLIDER_BluePipeTop, EVS_GotoMap_sff_01_5);
...
EvtScript EVS_BindExitTriggers = {
    ...
    BindTrigger(Ref(EVS_ExitPipe_sff_01_5), TRIGGER_FLOOR_TOUCH, COLLIDER_BluePipeTop, 1, 0)
    Return
    End
};
...
EvtScript EVS_Main ={
    ...
    Set(AF_SFF02_Oaklie_DialogueToggle, false)
...
MapSettings sff_02_settings = {
    .main = &sff_02::EVS_Main,
    .entryList = &sff_02::Entrances,
    .entryCount = ENTRY_COUNT(sff_02::Entrances),
